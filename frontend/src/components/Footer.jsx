  ...
  return (
    <footer ref={footerRef} className="relative bg-[#1a1a1a] text-white pt-20 pb-8 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-20 right-[10%] w-80 h-80 rounded-full bg-[#7B2958]/10 blur-3xl"
      />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-sm text-white/60">
                <MapPin className="h-4 w-4 mt-0.5 flex-shrink-0 text-[#7B2958]" />
                <span>{studio.address}<br />{studio.city}</span>
              </li>
              <li className="flex items-center gap-3 text-sm text-white/60">
                <Clock className="h-4 w-4 flex-shrink-0 text-[#7B2958]" />
                <span>{studio.hours}</span>
              </li>
              <li className="flex items-center gap-3 text-sm text-white/60">
                <Mail className="h-4 w-4 flex-shrink-0 text-[#7B2958]" />
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <form onSubmit={handleSubscribe} className="flex gap-3 w-full md:w-auto">
              ...
              <Button
                type="submit"
                className="bg-[#7B2958] hover:bg-[#5C1E42] text-white rounded-full px-6 transition-all duration-300 hover:shadow-lg hover:shadow-[#7B2958]/30"
              >
                Anmelden
              </Button>
            </form>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-white/40 flex items-center gap-1">
            Mit <Heart className="h-3 w-3 text-[#7B2958] fill-[#7B2958]" /> in Hamburg seit 2012
          </p>
        </div>
      </div>
    </footer>
