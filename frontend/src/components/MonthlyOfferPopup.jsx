        ...
        <>
          ...
          >
            <div className="relative w-full max-w-lg overflow-hidden rounded-3xl shadow-2xl">
              ...
              {/* Gradient Overlay */}
              <div className="absolute inset-0 bg-gradient-to-b from-[#7B2958]/90 via-[#5C1E42]/85 to-[#4a1535]/95" />
              ...
              <div className="relative p-8 md:p-10 text-center">
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-3">
                    <span className="text-6xl md:text-7xl font-bold text-white">67€</span>
                  </div>
                ...
                >
                  <a href="/buchen" onClick={handleClose}>
                    <Button className="w-full sm:w-auto bg-white hover:bg-white/90 text-[#7B2958] font-semibold px-8 py-6 rounded-full transition-all duration-300 hover:shadow-lg hover:shadow-white/20 hover:-translate-y-0.5">
