      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-40">
        <div className="max-w-xl lg:max-w-2xl text-center lg:text-left mx-auto lg:mx-0">
          ...
          >
            <a href="/buchen">
              <Button
                className="group relative overflow-hidden bg-[#7B2958] hover:bg-[#5C1E42] text-white text-base px-8 py-6 rounded-full font-medium transition-all duration-500 hover:shadow-2xl hover:shadow-[#7B2958]/40 hover:-translate-y-1"
              >
          ...
          <div className="relative w-72 lg:w-80 rounded-2xl overflow-hidden bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl shadow-black/20 transition-all duration-500 group-hover:scale-105 group-hover:shadow-3xl">
            ...
            <div className="relative aspect-video">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                >
                  <Play className="h-6 w-6 text-[#7B2958] ml-1" fill="#7B2958" />
                </motion.div>
              </div>
            </div>
            
            {/* Decorative Glow */}
            <div className="absolute -inset-1 bg-gradient-to-r from-[#7B2958]/20 to-[#C4A77D]/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity -z-10" />
          </div>
        </motion.div>
      </motion.div>
