    ...
    <section className="bg-[#F7F6F4] py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <p className="text-[#8B2F5F] text-sm tracking-wider uppercase mb-3">BEWERTUNGEN</p>
          ...
          <p className="text-[#666666]">
            ...
            <span className="font-semibold text-[#2B2B2B]">4.9 von 5</span> Sternen.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-[#8B2F5F]/10 rounded-full flex items-center justify-center">
                  <svg className="w-4 h-4 text-[#8B2F5F]" viewBox="0 0 24 24" fill="currentColor">
