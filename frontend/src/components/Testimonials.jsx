    ...
    <section ref={sectionRef} className="bg-[#F7F6F4] py-20 md:py-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          >
            <div className="relative h-full rounded-3xl overflow-hidden bg-white/70 backdrop-blur-xl border border-white/50 shadow-lg hover:shadow-2xl transition-all duration-500">
              {/* Video Thumbnail */}
              <div className="relative aspect-[4/3]">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  >
                    <Play className="h-7 w-7 text-[#7B2958] ml-1" fill="#7B2958" />
                  </motion.div>
                </div>

                {/* Video Badge */}
                <div className="absolute top-4 left-4">
                  <span className="px-3 py-1.5 rounded-full bg-[#7B2958] text-white text-xs font-medium shadow-lg">
                    VIDEO
                  </span>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <p className="text-[#2B2B2B] font-semibold mb-3">
                  "Eine wunderbare Erfahrung"
                </p>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-[#7B2958]/10 rounded-full flex items-center justify-center">
                    <span className="text-[#7B2958] font-bold text-xs">K</span>
                  </div>
                  <div>
          ...
          {testimonials.slice(0, 2).map((testimonial, index) => (
            ...
            >
              ...
              <div className="relative h-full bg-white/70 backdrop-blur-xl rounded-3xl p-6 shadow-lg shadow-black/5 border border-white/50 transition-all duration-500 group-hover:shadow-2xl group-hover:bg-white/90 flex flex-col">
                {/* Quote Icon */}
                <div className="absolute -top-3 -left-2 w-10 h-10 rounded-full bg-[#7B2958]/10 flex items-center justify-center">
                  <Quote className="h-4 w-4 text-[#7B2958]" />
                </div>
                ...
                {/* Quote */}
                <p className="text-[#2B2B2B] text-base leading-relaxed mb-6 flex-1">
                  "{testimonial.text}"
                </p>

                {/* Author */}
                <div className="flex items-center gap-3 pt-4 border-t border-[#E5E2DD] mt-auto">
                  <div className="w-10 h-10 bg-[#7B2958]/10 rounded-full flex items-center justify-center">
                    <span className="text-[#7B2958] font-bold text-sm">
        ...
        >
          <div className="relative bg-white/70 backdrop-blur-xl rounded-3xl p-8 shadow-lg shadow-black/5 border border-white/50 transition-all duration-500 group-hover:shadow-2xl group-hover:bg-white/90">
            <div className="flex flex-col md:flex-row md:items-center gap-6">
              {/* Quote Icon */}
              <div className="w-14 h-14 rounded-full bg-[#7B2958]/10 flex items-center justify-center flex-shrink-0">
                <Quote className="h-6 w-6 text-[#7B2958]" />
              </div>
