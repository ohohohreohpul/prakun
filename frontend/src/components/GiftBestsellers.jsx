  ...
  return (
    <section ref={sectionRef} className="bg-[#F7F6F4] py-20 md:py-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.span 
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#7B2958]/10 text-[#7B2958] text-sm font-medium mb-4"
          >
                  ...
                  <div className="relative rounded-3xl overflow-hidden bg-[#E5E2DD] aspect-[3/4] mb-5 shadow-lg shadow-black/5 transition-all duration-500 group-hover:shadow-2xl group-hover:shadow-black/10">
                    ...
                    {product.isNew && (
                      <motion.span
                        ...
                        className="absolute top-4 right-4 bg-[#7B2958] text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg"
                      >
                        NEU
                      </motion.span>
                    )}
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <div className="bg-white/80 backdrop-blur-xl rounded-xl p-3 border border-white/50 transform translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                        <p className="text-[#7B2958] font-bold text-lg">ab {product.price} €</p>
                      </div>
                    </div>
                  </div>
                  <h3 className="text-base font-bold text-[#2B2B2B] mb-1 group-hover:text-[#7B2958] transition-colors duration-300">
                    {product.title}
                  </h3>
        ...
        >
          <a href="/buchen">
            <Button className="group relative overflow-hidden bg-[#7B2958] hover:bg-[#5C1E42] text-white text-base px-8 py-5 rounded-full transition-all duration-500 hover:shadow-xl hover:shadow-[#7B2958]/30 hover:-translate-y-1">
