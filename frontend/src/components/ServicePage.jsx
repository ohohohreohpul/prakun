    ...
    return (
      <div className="min-h-screen bg-[#F7F6F4] flex items-center justify-center">
        <div className="text-center">
          ...
          <a href="/" className="text-[#7B2958] hover:underline">Zurück zur Startseite</a>
        </div>
      </div>
    );
  }
              ...
              >
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-12">
                  {service.benefits.map((benefit, index) => (
                    ...
                    >
                      <div className="w-6 h-6 rounded-full bg-[#7B2958]/10 flex items-center justify-center flex-shrink-0">
                        <Check className="h-4 w-4 text-[#7B2958]" />
                      </div>
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-8 border border-white/50 shadow-2xl shadow-black/5">
                  ...
                  <div className="space-y-3 mb-8">
                    {service.pricing.map((option, index) => (
                      <motion.div
                        ...
                        className="flex items-center justify-between p-4 rounded-xl bg-[#F7F6F4] hover:bg-[#7B2958]/5 transition-colors cursor-pointer group"
                      >
                        <div className="flex items-center gap-3">
                          <Clock className="h-4 w-4 text-[#7B2958]" />
                          <span className="font-medium text-[#2B2B2B]">{option.duration}</span>
                        </div>
                        <span className="text-lg font-bold text-[#7B2958] group-hover:scale-105 transition-transform">
                          {option.price}€
                        </span>
                      </motion.div>
                    ))}
                  ...
                  <a href="/buchen">
                    <Button className="w-full group relative overflow-hidden bg-[#7B2958] hover:bg-[#5C1E42] text-white text-base py-6 rounded-full transition-all duration-500 hover:shadow-xl hover:shadow-[#7B2958]/30 mb-4">
                ...
                <motion.div
                  ...
                  className="mt-6 p-4 rounded-2xl bg-[#7B2958]/5 border border-[#7B2958]/10 text-center"
                >
                ...
                >
                  ...
                  >
                    <div className="relative h-48 overflow-hidden">
                      ...
                      {relService.isNew && (
                        <span className="absolute top-4 right-4 bg-[#7B2958] text-white text-xs font-bold px-3 py-1 rounded-full">
                          NEU
                        </span>
                      )}
                    </div>
                    <div className="p-6">
                      <h3 className="text-lg font-bold text-[#2B2B2B] mb-2 group-hover:text-[#7B2958] transition-colors">
                        {relService.title}
                      </h3>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-[#7B2958]">ab {relService.priceFrom}€</span>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <Heart className="h-12 w-12 text-[#7B2958] mx-auto mb-6" />
            ...
            <a href="/buchen">
              <Button className="group relative overflow-hidden bg-[#7B2958] hover:bg-[#5C1E42] text-white text-lg px-10 py-6 rounded-full transition-all duration-500 hover:shadow-2xl hover:shadow-[#7B2958]/30 hover:-translate-y-1">
