        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-[#2B2B2B] mb-6 leading-tight">
              Wie können wir
              <br />
              <span className="text-[#3D1A6B]">Ihnen helfen?</span>
            </h2>
            ...
            >
              ...
              <a
                ...
                className="text-[#3D1A6B] font-bold text-xl hover:underline transition-all"
              >
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {faqItems.map((item, index) => (
                ...
                >
                  ...
                  >
                    <AccordionTrigger className="px-6 py-5 hover:no-underline text-left font-semibold text-[#2B2B2B] hover:text-[#3D1A6B] transition-colors">
                      {item.question}
                    </AccordionTrigger>
